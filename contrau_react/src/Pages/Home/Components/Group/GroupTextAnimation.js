          ...
          <div className="text-white mt-[45px] 2xl:mt-[90px] ">
            <div className="2xl:mr-[-70px]">
              <p className="popinsFont  text-[13px] 2xl:text-[20px] leading-[20px] 2xl:leading-[32px] font-[300]">
                We once encountered the challenges facing many startup-ers these
                days. We are here to accompany them on this arduous yet exciting
                journey. Different linguistic and cultural backgrounds don’t
                matter when we look in the same direction.
              </p>
