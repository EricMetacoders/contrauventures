...
export default function MobileImgCarousel({ data }) {
  ...
  return (
    <>
      <div
        id="divBtn"
        className="mt-[60px] mb-[80px] relative imgCarousel w-[280px] h-[448px] md:w-[223px] md:h-[350px] xl:h-[550px] xl:w-[323px] 2xl:h-[664px] 2xl:w-[424px] rounded-3xl overflow-hidden"
      >
        <img
          src={data?.acf?.image}
          alt={data?.acf?.name}
