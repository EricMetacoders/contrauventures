        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            <div className="border-b-2 border-darkGrey">
              <p className="font-bold text-[14px] md:text-[16px]">view more</p>
            </div>
          </div>
        </div>
        <div className="mt-[109px]">
          <div className="flex flex-col 2xl:flex-row items-center justify-center 2xl:space-x-6">
            <div className="2xl:w-[428px] 2xl:h-[399px] w-[291px] h-[377px] border-b-2 border-black pb-[20px] mb-[50px]">
              <img
                src={news_photo1}
                alt="news1"
              ...
              <div className="mt-[36px]">
                <p className="text-[14px] robotoFont italic text-red">
                  Category
                </p>
                <p className="2xl:text-[26px] 2xl:font-normal text-[18px] font-light ">
                  What happens when AI and NFT meets?
                </p>
                <p className="2xl-text[16px] 2xl:font-light 2xl:robotoFont text-[16px] font-light">
