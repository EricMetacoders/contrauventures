          ...
          <div className="hidden md:block leading-[1] mt-[50px]">
            ...
            <div className="flex items-center justify-start space-x-5 ">
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="inline-block  bg-red w-[10px] h-[10px] xl:w-[23px] xl:h-[23px] rounded-full  mt-[30px] xl:mt-[54px] "></div>
              </div>
            </div>
          </div>
          <div className="block md:hidden leading-[1] mt-[27px] ">
            <p className="italic text-[40px] font-thin ">We don't</p>
            <p className="italic text-[40px] font-thin  ">go for Deals,</p>
            <p className="font-extrabold italic text-[40px]">We go for</p>
            <p className=" font-extrabold italic text-[40px] text-red">
              Founders
            </p>
          </div>
          <div className="text-[13px] mr-[80px] md:text-[20px] mt-[70px] ">
            <p>
