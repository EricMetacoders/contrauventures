...
export default function Group() {
  return (
    <div className="bg-black h-[1600px] overflow-hidden">
      <div className="ml-[30px] md:ml-0 md:container md:mx-auto md:px-[127px] pb-[200px] ">
        <div className="pt-[80px] xl:pt-[324px] ">
          <div>
            <p className="text-white robotoFont text-[24px] mb-[54px]">
              Partners
            </p>
            <div className="hidden xl:block">
              <div className="text-white  leading-[1]">
                <span className=" text-[110px] font-bold">We are </span>
                <span className=" italic text-[110px] font-thin">
                  a Fund of Korean{" "}
                </span>
                <span className=" text-[110px] font-bold">FOUNDERS</span>
                <div className="inline-block bg-red w-[23px] h-[23px] rounded-full"></div>
              </div>
            </div>
          ...
          <div className="text-white mt-[45px] 2xl:mt-[90px] ">
            <div className="mr-[55px]">
              ...
              <p className="text-[13px] pt-[24px]  leading-[20px] font-light mr-[20px]">
